...
import { IonPage, IonContent, IonHeader, IonToolbar, IonButton, IonIcon, IonSpinner } from "@ionic/react";
...
const ChatFrame: React.FC = () => {
  ...
  const sendMessageToIframe = () => {
    ...
    const iframe = document.querySelector('iframe.fullscreen-iframe') as HTMLIFrameElement;
      ...
      <IonContent fullscreen>
        {isLoading && (
          <div className="chatLoad">
            <IonSpinner color={"primary"} name="crescent" className="h-20px w-20px" />
          </div>
        )}

...
import { menuOutline, searchOutline, notificationsOutline, optionsOutline } from "ionicons/icons";
    ...
    <IonPage className="Journalcalender">
      ...
      <IonContent className="ion-padding-horizontal" fullscreen>
        ...
        <div className="calender-holder">
          <IonDatetime ref={datetime} presentation="date" multiple={true} id="daettime"
        ...
        <div className="title flex al-center jc-between ion-padding-bottom">
          <h3>Intention: <span>Gratitude</span></h3>
